...
** Last update Fri Mar 11 00:04:10 2016 victor sousa
*/

#include	"main.h"

int			get_center(t_sphere *s, char **file, int id)
{
  char			*lf;
  char			*get;
...
int			get_radius(t_sphere *s, char **file, int id)
{
  char			*lf;
  char			*get;
...
int			get_mat_id(t_sphere *s, char **file, int id)
{
  char			*lf;
  char			*get;

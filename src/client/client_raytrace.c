...
** Last update Fri May 20 21:55:26 2016 Philippe Lefevre
*/
...
int			load_scene_open(t_prog *prog, char *str)
{
  ...
  if ((get = get_field(file, "scene:view:x_size")) == NULL)
    {
      my_printf(2, "Could not find scene:view:x_size\n");
      return (-1);
    }
  ...
  if ((get = get_field(file, "scene:view:y_size")) == NULL)
    {
      my_printf(2, "Could not find scene:view:y_size\n");
      return (-1);
    }
  ...
  if ((get = get_field(file, "scene:view:fov")) == NULL)
    {
      my_printf(2, "Could not find scene:view:fov\n");
      return (-1);
    }
  ...
  if ((get = get_field(file, "scene:view:alias")) == NULL)
    {
      my_printf(2, "Could not find scene:view:alias\n");
      return (-1);
    }
  ...
  if ((get = get_field(file, "scene:view:background")) == NULL)
    {
      my_printf(2, "Could not find scene:view:background\n");
      return (-1);
    }
  ...
  if (prog->look_at.x == prog->cam_pos.x &&
    ...
    {
      my_printf(2, "Wrong camera placement\n");
      return (-1);
    }

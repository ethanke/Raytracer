...
public:
    ...
    QLineEdit *lineEdit_ss;
    QLabel *label_11;
    QLabel *label_12;
    QComboBox *comboBox_ao;
    QWidget *tab_2;
    QTableWidget *listObject;
    QPushButton *editButtonObj;
    QPushButton *editButtonObj_2;
    QPushButton *editButtonObj_4;
    QWidget *tab;
    QTableWidget *listLight;
    QWidget *tab_3;
    QTableWidget *listMat;
    QPushButton *editButtonObj_3;
    QPushButton *editButtonObj_5;
    QPushButton *editButtonObj_6;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        loadButton_2 = new QPushButton(groupBox_3);
        loadButton_2->setObjectName(QStringLiteral("loadButton_2"));
        loadButton_2->setGeometry(QRect(160, 0, 161, 61));
        loadButton_2->setIcon(icon);
        loadButton_2->setIconSize(QSize(32, 32));
        loadButton_2->setAutoDefault(true);
        loadButton_2->setFlat(false);
...
""));
        ...
        lineEdit_ss = new QLineEdit(camera);
        lineEdit_ss->setObjectName(QStringLiteral("lineEdit_ss"));
        lineEdit_ss->setGeometry(QRect(170, 460, 113, 21));
        label_11 = new QLabel(camera);
        label_11->setObjectName(QStringLiteral("label_11"));
        label_11->setGeometry(QRect(30, 460, 121, 21));
        sizePolicy.setHeightForWidth(label_11->sizePolicy().hasHeightForWidth());
        label_11->setSizePolicy(sizePolicy);
        label_12 = new QLabel(camera);
        label_12->setObjectName(QStringLiteral("label_12"));
        label_12->setGeometry(QRect(10, 420, 131, 21));
        sizePolicy.setHeightForWidth(label_12->sizePolicy().hasHeightForWidth());
        label_12->setSizePolicy(sizePolicy);
        comboBox_ao = new QComboBox(camera);
        comboBox_ao->setObjectName(QStringLiteral("comboBox_ao"));
        comboBox_ao->setGeometry(QRect(150, 420, 111, 26));
...
"}"));
        ...
        editButtonObj->setEnabled(false);
        editButtonObj->setGeometry(QRect(150, 210, 41, 41));
        QIcon icon1;
        ...
        editButtonObj_2 = new QPushButton(tab_2);
        editButtonObj_2->setObjectName(QStringLiteral("editButtonObj_2"));
        editButtonObj_2->setEnabled(false);
        editButtonObj_2->setGeometry(QRect(90, 210, 41, 41));
        QIcon icon2;
        icon2.addFile(QStringLiteral("../../../../Downloads/cross-remove-sign.png"), QSize(), QIcon::Normal, QIcon::Off);
        editButtonObj_2->setIcon(icon2);
        editButtonObj_2->setIconSize(QSize(32, 32));
        editButtonObj_2->setAutoDefault(true);
        editButtonObj_2->setFlat(false);
        editButtonObj_4 = new QPushButton(tab_2);
        editButtonObj_4->setObjectName(QStringLiteral("editButtonObj_4"));
        editButtonObj_4->setEnabled(false);
        editButtonObj_4->setGeometry(QRect(30, 210, 41, 41));
        QIcon icon3;
        icon3.addFile(QStringLiteral("../../../../Downloads/plus.png"), QSize(), QIcon::Normal, QIcon::Off);
        editButtonObj_4->setIcon(icon3);
        editButtonObj_4->setIconSize(QSize(32, 32));
        editButtonObj_4->setAutoDefault(true);
        editButtonObj_4->setFlat(false);
...
"}"));
        ...
        editButtonObj_3 = new QPushButton(tab_3);
        editButtonObj_3->setObjectName(QStringLiteral("editButtonObj_3"));
        editButtonObj_3->setEnabled(false);
        editButtonObj_3->setGeometry(QRect(90, 210, 41, 41));
        editButtonObj_3->setIcon(icon2);
        editButtonObj_3->setIconSize(QSize(32, 32));
        editButtonObj_3->setAutoDefault(true);
        editButtonObj_3->setFlat(false);
        editButtonObj_5 = new QPushButton(tab_3);
        editButtonObj_5->setObjectName(QStringLiteral("editButtonObj_5"));
        editButtonObj_5->setEnabled(false);
        editButtonObj_5->setGeometry(QRect(30, 210, 41, 41));
        editButtonObj_5->setIcon(icon3);
        editButtonObj_5->setIconSize(QSize(32, 32));
        editButtonObj_5->setAutoDefault(true);
        editButtonObj_5->setFlat(false);
        editButtonObj_6 = new QPushButton(tab_3);
        editButtonObj_6->setObjectName(QStringLiteral("editButtonObj_6"));
        editButtonObj_6->setEnabled(false);
        editButtonObj_6->setGeometry(QRect(150, 210, 41, 41));
        editButtonObj_6->setIcon(icon1);
        editButtonObj_6->setIconSize(QSize(32, 32));
        editButtonObj_6->setAutoDefault(true);
        editButtonObj_6->setFlat(false);
        tabWidget->addTab(tab_3, QString());
        pushButton_3 = new QPushButton(centralWidget);
        pushButton_3->setObjectName(QStringLiteral("pushButton_3"));
        pushButton_3->setGeometry(QRect(40, 80, 211, 32));
        pushButton_3->setMaximumSize(QSize(1080, 720));
        saveButton = new QPushButton(centralWidget);
        saveButton->setObjectName(QStringLiteral("saveButton"));
        saveButton->setGeometry(QRect(570, 70, 120, 40));
        glWdiget = new GlWindow(centralWidget);
        glWdiget->setObjectName(QStringLiteral("glWdiget"));
        glWdiget->setGeometry(QRect(380, 150, 1080, 720));
        ...
        QObject::connect(renderButton, SIGNAL(clicked()), glWdiget, SLOT(raytrace_button()));
        QObject::connect(saveButton, SIGNAL(clicked()), glWdiget, SLOT(save_button()));

        loadButton->setDefault(false);
        loadButton_2->setDefault(false);
        pushButton->setDefault(false);
        tabWidget->setCurrentIndex(0);
        editButtonObj->setDefault(false);
        editButtonObj_2->setDefault(false);
        editButtonObj_4->setDefault(false);
        editButtonObj_3->setDefault(false);
        editButtonObj_5->setDefault(false);
        editButtonObj_6->setDefault(false);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        loadButton_2->setText(QApplication::translate("MainWindow", "Unload scene", 0));
        ...
        lineEdit_ss->setText(QString());
        lineEdit_ss->setPlaceholderText(QApplication::translate("MainWindow", " into 1 to 1024", 0));
        label_11->setText(QApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt;\">Shadow Sampling :</span></p></body></html>", 0));
        label_12->setText(QApplication::translate("MainWindow", "<html><head/><body><p>Soft Shadow :</p></body></html>", 0));
        comboBox_ao->setCurrentText(QString());
        ...
        editButtonObj_2->setText(QString());
        editButtonObj_4->setText(QString());
        ...
        editButtonObj_3->setText(QString());
        editButtonObj_5->setText(QString());
        editButtonObj_6->setText(QString());
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("MainWindow", "Mat\303\251riaux", 0));
        pushButton_3->setText(QApplication::translate("MainWindow", "Laod xml magique", 0));
        saveButton->setText(QApplication::translate("MainWindow", "Save as .png", 0));
    } // retranslateUi

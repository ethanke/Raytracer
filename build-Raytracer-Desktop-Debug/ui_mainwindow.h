...
"}"));
        ...
        pushButton_3->setGeometry(QRect(120, 90, 211, 32));
        pushButton_3->setMaximumSize(QSize(1080, 720));
        renderButton_2 = new QPushButton(centralWidget);
        renderButton_2->setObjectName(QStringLiteral("renderButton_2"));
        renderButton_2->setGeometry(QRect(540, 70, 120, 40));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_3->setText(QApplication::translate("MainWindow", "Loaod xml magique", 0));
        renderButton_2->setText(QApplication::translate("MainWindow", "Raytrace it!", 0));
    } // retranslateUi
